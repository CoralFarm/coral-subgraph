...
import { CRLFactory, CRLPair, Token, Bundle } from '../types/schema'
...
export function handleNewPair(event: PairCreated): void {
    ...
    if (factory === null) {
        factory = new CRLFactory(FACTORY_ADDRESS)
        factory.pairCount = 0
    ...
    let pair = new CRLPair(event.params.pair.toHexString()) as CRLPair
